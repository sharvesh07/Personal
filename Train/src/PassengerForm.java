...
public class PassengerForm {
    ...
    private static String filePath = "passenger_data.txt";
    private static String journeyFilePath = "train_journey_details.txt";    static int lastTicketNumber = 0;
    static Scanner scanner = new Scanner(System.in);

    private static Booking_Check bookingCheck = new Booking_Check(filePath, journeyFilePath);

    public static void main(String[] args) {
        int choice;

        // Load existing passenger data at the start
        bookingCheck.loadPassengerData();
    ...
    public static void createNewTickets() {
        clearScreen();
        ...
        // Check booking logic using TrainJourney
        if (TrainJourney.canBoardPassenger(passenger)) {
            ...
            System.out.println("Booking failed due to capacity or route constraints.");
        }
    }
    ...
    private static void clearScreen() {
        // This method might not work on all terminals; consider a cross-platform approach if needed.
